...
export class FetchWorkShiftService {
  visible:boolean = false
  //get holiday date as an input ID for PUT method
  workShiftId:string | undefined = ''
  workShiftType:string | undefined = ''

  toggleLiveDemo(id?:string, type?:string) {
    this.visible = !this.visible;
    this.workShiftId = id
    this.workShiftType = type
    console.log(this.workShiftType)
  }
